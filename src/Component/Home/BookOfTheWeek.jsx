    ...
    <div className='mt-5'>
     ...
     <div className='mt-5 p-5 bg-orange-200 shadow rounded-md border border-gray-300'>
       <div className='flex justify-around items-center md:flex-row flex-col-reverse '>
        <div className='space-y-3 mt-5 md:mt-0 text-[#f22e07]'>
      ...
      <p className='md:px-35 py-5 md:mx-11 text-[#f22e07]'><span className='font-bold underline'>Summary :</span>"A neuroscientist explores the untapped potential of the human brain through groundbreaking research."</p>
     </div>
    </div>
  );
};
